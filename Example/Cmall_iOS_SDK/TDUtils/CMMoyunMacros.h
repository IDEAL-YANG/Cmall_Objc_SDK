...
//#define DegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
//#define RadiansToDegrees(CGFloat radians) {return radians * 180 / M_PI;};
...
#define ABRelease(x)            [x release], x = nil
...
#define CMWeak(obj)  __weak typeof(obj)weak##obj = obj;
/* ****************************************************************************************************************** */
...
#define ApplicationDebug       @"recursiveDescription"
...
#define kTabbarBarHeight        (49.f)
#define kArtBulbTabbarHeight    (45.f)
#define kRefreshControlHeight  (60.f)
...
// 加载图片
#define PNGIMAGE(NAME)          [UIImage imageNamed:[NSString stringWithFormat:@"%@.png",(NAME)]]
...
// 主题字体，方正描五
#define THEMEFONT(FONTSIZE)    FONT(kTudeThemFont,FONTSIZE)
...
// 是否是iPhone5及其以下设备
#define isBelowiPhone5                ([UIScreen mainScreen].bounds.size.width * 2 <= 640 ? YES : NO)
...
/*
 加载指定的strings
#define LocalString(x, ...)     NSLocalizedStringFromTable(x,@"Chinese", nil)
 */
...
#define LBDispatch_main_sync_safe(block)\
