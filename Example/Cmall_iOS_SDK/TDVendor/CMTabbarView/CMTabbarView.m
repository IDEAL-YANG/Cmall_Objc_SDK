...
CGFloat const CMSDKTabBarViewTabOffsetInvalid = -1.0f;
...
- (void)commonInit
{
    ...
    _tabbarOffsetX = CMSDKTabBarViewTabOffsetInvalid;
...
- (void)reloadData
{
    ...
    if (self.tabbarOffsetX == CMSDKTabBarViewTabOffsetInvalid && _defaultSelectedIndex < mutaArray.count) {
...
{
    if (self.tabbarOffsetX == CMSDKTabBarViewTabOffsetInvalid) {
