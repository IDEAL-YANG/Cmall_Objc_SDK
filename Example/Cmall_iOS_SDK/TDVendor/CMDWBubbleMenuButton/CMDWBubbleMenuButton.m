...
@interface CMDWBubbleMenuButton ()
...
@implementation CMDWBubbleMenuButton
...
- (void)removeButtons
{
    [self.buttonContainer removeAllObjects];
    for (UIView *btn in self.subviews) {
        @autoreleasepool {
            if (![btn isEqual:self.homeButtonView]) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                ...
                finalPosition = CGPointMake(self.frame.size.width/2.f,
                                            self.frame.size.height - 20 - self.homeButtonView.frame.size.height - self.buttonSpacing - button.frame.size.height/2.f
