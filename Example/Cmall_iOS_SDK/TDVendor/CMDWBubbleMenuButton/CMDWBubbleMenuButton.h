//
//  CMDWBubbleMenuButton.h
//  CMDWBubbleMenuButtonExample
//
...
typedef void(^HaveShowed)(void);

typedef void(^HaveDissmiss)(void);

@class CMDWBubbleMenuButton;

@protocol DWBubbleMenuViewDelegate <NSObject>

@optional
- (void)bubbleMenuButtonWillExpand:(CMDWBubbleMenuButton *)expandableView;
- (void)bubbleMenuButtonDidExpand:(CMDWBubbleMenuButton *)expandableView;
- (void)bubbleMenuButtonWillCollapse:(CMDWBubbleMenuButton *)expandableView;
- (void)bubbleMenuButtonDidCollapse:(CMDWBubbleMenuButton *)expandableView;

@end

@interface CMDWBubbleMenuButton : UIView <UIGestureRecognizerDelegate>
...
@property (copy, nonatomic) HaveShowed haveShowed;

@property (copy, nonatomic) HaveDissmiss haveDissmiss;
